...
public class HlsSegmentPrefetchPlannerTest {
    ...
    @Test
    public void planSegmentUrisReturnsTailTsSegmentsResolvedAgainstPlaylist() {
        ...
        assertEquals("http://example.com/live/seg_101.ts?token=b", result.get(0).toString());
        assertEquals("http://example.com/live/seg_102.ts?token=c", result.get(1).toString());
    }
